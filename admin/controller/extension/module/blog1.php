<?php
class ControllerExtensionModuleBlog1 extends Controller {
	...
	public function install() {
		...
		$settings['module_blog_status'] = 1;

		$this->model_setting_setting->editSetting('module_blog', $settings);
	}
	...
	public function configure() {
		...
		if (!$this->user->hasPermission('modify', 'extension/extension/module')) {
			...
			$this->model_user_user_group->addPermission($this->user->getGroupId(), 'access', 'extension/module/blog');
			$this->model_user_user_group->addPermission($this->user->getGroupId(), 'modify', 'extension/module/blog');
