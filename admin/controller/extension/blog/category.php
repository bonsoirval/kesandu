...
class ControllerExtensionBlogCategory extends Controller {
	...
	public function index() {
		$this->load->language('extension/blog/category');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/blog/category', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['action'] = $this->url->link('extension/blog/category', 'user_token=' . $this->session->data['user_token'], true);
		...
		$this->response->setOutput($this->load->view('extension/blog/category', $data));
	}
	...
	// 		}
	//
	// 		return $this->load->view('extension/blog/category_info', $data);
	// 	}
	// }
	//
